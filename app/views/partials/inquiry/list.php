                                        ...
                                        <table class="table  table-striped table-sm text-left table-bordered">
                                            <thead class="table-header bg-light">
                                                <tr>
                                                    ...
                                                    <th  class="td-total_pax"> Total Room</th>
                                                    <th  class="td-event_type"> Coverage Area</th>
                                                    <th  class="td-event_time">  Package</th>
                                            ...
                                            <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-total_room"> <?php echo $data['total_room']; ?></td>
                                                    <td class="td-coverage_area"> <?php echo $data['coverage_area']; ?></td>
                                                    <td class="td-package"> <?php echo $data['package']; ?></td>
